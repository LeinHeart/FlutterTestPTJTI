...
import 'package:flutter_test_pt_jelajah_teknologi_negeri/module/submenu/keluar/widget/currency_row_keluar.dart';
import '../controller/keluar_controller.dart';
import 'package:flutter_test_pt_jelajah_teknologi_negeri/core.dart';
import 'package:get/get.dart';

class KeluarView extends StatelessWidget {
  const KeluarView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<KeluarController>(
      init: KeluarController(),
      builder: (controller) {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          // -- Judul
                          EmptyTextField(title: "Judul"),

                          // -- Input Currency
                          CurrencyInputKeluarRow(),

                          // -- Photo
                          SelectPhotoRow(),

                          // -- Keterangan
                          EmptyTextField(title: "Keterangan"),
