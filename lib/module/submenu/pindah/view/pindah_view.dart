...
import 'package:flutter_test_pt_jelajah_teknologi_negeri/module/submenu/pindah/widget/currency_input_pindah_row.dart';
import '../controller/pindah_controller.dart';
import 'package:flutter_test_pt_jelajah_teknologi_negeri/core.dart';
import 'package:get/get.dart';

class PindahView extends StatelessWidget {
  const PindahView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<PindahController>(
      init: PindahController(),
      builder: (controller) {
                        ...
                        Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton2<OutletListItem>(
                              value: controller.selectedOutletDari,
                              ...
                              onChanged: (value) =>
                                  controller.updateSelectedOutletDari(value!),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton2<OutletListItem>(
                              value: controller.selectedOutletKe,
                              iconStyleData: const IconStyleData(
                                icon: Icon(Icons.keyboard_arrow_down),
                                iconEnabledColor: AppColors.primaryBlue,
                              ),
                              ...
                              onChanged: (value) =>
                                  controller.updateSelectedOutletKe(value!),
                              onMenuStateChange: (isOpen) {
                                controller.updateIsSelectingOutlet(isOpen);
                              },
                              items: controller.outletListItems
