...
class CurrencyInputKursKeRow extends StatelessWidget {
  const CurrencyInputKursKeRow({
    super.key,
  });
            ...
            children: [
              ...
              DropdownButtonHideUnderline(
                child: DropdownButton2<CurrencyType>(
                  value: controller.selectedCurrencyKe,
                  ...
                  onChanged: (value) =>
                      controller.updateSelectedCurrencyKe(value!),
