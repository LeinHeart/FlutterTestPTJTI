...
class CurrencyInputKursDariRow extends StatelessWidget {
  const CurrencyInputKursDariRow({
    super.key,
  });

  @override
  Widget build(BuildContext context) {
    final controller = KursController.instance;
            ...
            children: [
              ...
              DropdownButtonHideUnderline(
                child: DropdownButton2<CurrencyType>(
                  value: controller.selectedCurrencyDari,
                  ...
                  onChanged: (value) =>
                      controller.updateSelectedCurrencyDari(value!),
